...
class Coffee extends Component{
  ...
  <>
    ...
    {this.state.cupHeight?<div onClick={this.resetCup} id='coffeeWords' ><h4>UCLA class of 2018</h4><h4>BA - Political Science</h4><h4>General Assembly - Software Engineering Immersive</h4></div>:<h1 style={{position:'absolute',top:'35.5vh',right:'43vh',zIndex:'32'}}><u>Education</u></h1>}
